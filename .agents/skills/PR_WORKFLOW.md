...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (text2llm#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.text2llm.ai/help/submitting-a-pr)) for what we expect from contributors.
