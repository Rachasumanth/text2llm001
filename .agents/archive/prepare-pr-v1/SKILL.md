...
- `fix: <summary> (text2llm#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (text2llm#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "text2llm#$pr_number" || { echo "ERROR: commit subject missing text2llm#$pr_number"; exit 1; }
