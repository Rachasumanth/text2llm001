...
text2llm has two separate “streaming” layers:
...
When block streaming is enabled, text2llm can **merge consecutive block chunks**
...
When draft streaming is active, text2llm disables block streaming for that reply to avoid double-streaming.
