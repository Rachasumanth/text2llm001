...
本指南总结了在 text2llm 中开发 Pi 集成的合理工作流程。
...
状态存储在 text2llm 状态目录下。默认为 `~/.text2llm`。如果设置了 `TEXT2LLM_STATE_DIR`，则使用该目录。
...
- https://docs.text2llm.ai/testing
- https://docs.text2llm.ai/start/getting-started
