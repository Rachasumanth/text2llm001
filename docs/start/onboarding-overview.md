---
summary: "Overview of text2llm onboarding options and flows"
read_when:
...
text2llm supports multiple onboarding paths depending on where the Gateway runs
...
- [`text2llm onboard` command](/cli/onboard)

## macOS app onboarding

Use the text2llm app when you want a fully guided setup on macOS. Docs:
