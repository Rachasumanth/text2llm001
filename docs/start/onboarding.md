---
summary: "First-run onboarding flow for text2llm (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give text2llm">
...
<Step title="CLI">
  ...
  The app can install the global `text2llm` CLI via npm/pnpm so terminal
