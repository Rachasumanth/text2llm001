...
This guide summarizes a sane workflow for working on the pi integration in text2llm.
...
- Trigger the agent directly:
  - `pnpm text2llm agent --message "Hello" --thinking low`
...
State lives under the text2llm state directory. Default is `~/.text2llm`. If `TEXT2LLM_STATE_DIR` is set, use that directory instead.

To reset everything:

- `text2llm.json` for config
...
- [https://docs.text2llm.ai/testing](https://docs.text2llm.ai/testing)
- [https://docs.text2llm.ai/start/getting-started](https://docs.text2llm.ai/start/getting-started)
