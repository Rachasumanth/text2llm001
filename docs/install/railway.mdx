...
Deploy text2llm on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/text2llm` — Control UI
...
- `TEXT2LLM_STATE_DIR=/data/.text2llm` (recommended)
- `TEXT2LLM_WORKSPACE_DIR=/data/workspace` (recommended)
- `TEXT2LLM_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your text2llm state + workspace so you can migrate to another host without losing config or memory.
