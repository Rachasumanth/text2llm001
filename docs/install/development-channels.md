...
text2llm ships three update channels:
...
When you **explicitly** switch channels with `--channel`, text2llm also aligns
the install method:
...
When you switch channels with `text2llm update`, text2llm also syncs plugin sources:
