...
Deepgram is a speech-to-text API. In text2llm it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, text2llm uploads the audio file to Deepgram and injects the transcript
