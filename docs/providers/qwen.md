---
summary: "Use Qwen OAuth (free tier) in text2llm"
read_when:
  - You want to use Qwen with text2llm
...
If you already logged in with the Qwen Code CLI, text2llm will sync credentials
