---
summary: "Use Qianfan's unified API to access many models in text2llm"
read_when:
...
3. text2llm installed on your system
...
4. Copy the API key for use with text2llm

## CLI setup

```bash
text2llm onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [text2llm Configuration](/gateway/configuration)
