---
summary: "Use Synthetic's Anthropic-compatible API in text2llm"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. text2llm registers it as the
...
Note: text2llm's Anthropic client appends `/v1` to the base URL, so use
