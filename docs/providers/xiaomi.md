---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with text2llm"
read_when:
  - You want Xiaomi MiMo models in text2llm
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). text2llm uses
