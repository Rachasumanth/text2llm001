...
You can point text2llm at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or text2llm
...
- [Anthropic provider](/providers/anthropic) - Native text2llm integration with Claude setup-token or API keys
