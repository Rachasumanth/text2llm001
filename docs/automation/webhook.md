...
read_when:
  ...
  - Wiring external systems into text2llm
title: "Webhooks"
---
...
- `text2llm webhooks gmail setup` writes `hooks.gmail` config for `text2llm webhooks gmail run`.
