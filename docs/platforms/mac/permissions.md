...
- Same path: run the app from a fixed location (for text2llm, `dist/text2llm.app`).
...
Workaround: move files into the text2llm workspace (`~/.text2llm/workspace`) if you want to avoid per-folder grants.
