...
This is a living document maintained by the text2llm community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the text2llm AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| text2llm Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
...
| **Description**         | Attacker scans for exposed text2llm gateway endpoints                |
...
| **Affected Components** | ~/.text2llm/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | text2llm Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **ClawHub**          | text2llm's skill marketplace                              |
| **Gateway**          | text2llm's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for text2llm agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@text2llm.ai_
