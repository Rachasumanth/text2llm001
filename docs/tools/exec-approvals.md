...
- **gateway host** → `text2llm` process on the gateway machine
...
`~/.text2llm/exec-approvals.json` directly.

CLI: `text2llm approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
