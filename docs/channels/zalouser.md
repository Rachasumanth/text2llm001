...
read_when:
  - Setting up Zalo Personal for text2llm
...
- Install via CLI: `text2llm plugins install @text2llm/zalouser`
- Or from a source checkout: `text2llm plugins install ./extensions/zalouser`
...
- `text2llm pairing list zalouser`
- `text2llm pairing approve zalouser <code>`
...
- On startup, text2llm resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `text2llm channels logout --channel zalouser && text2llm channels login --channel zalouser`
