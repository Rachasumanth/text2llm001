...
read_when:
  - You want text2llm to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables text2llm to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`text2llm onboard`) and `text2llm channels add` list optional channel plugins.
...
```bash
text2llm plugins install --link <path-to-text2llm>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "text2llm",
        "displayName": "text2llm",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "text2llm@example.com",
        "lud16": "text2llm@example.com"
      }
    }
  }
}
