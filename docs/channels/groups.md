...
text2llm treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

text2llm “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, text2llm can see that group and respond there.
...
Translation: allowlisted senders can trigger text2llm by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@text2llm", "text2llm", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
