...
- Install via CLI: `text2llm plugins install @text2llm/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `text2llm plugins install ./extensions/zalo`
   - From npm (if published): `text2llm plugins install @text2llm/zalo`
...
- Approve via:
  - `text2llm pairing list zalo`
  - `text2llm pairing approve zalo <CODE>`
...
- Example: `text2llm message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `text2llm channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `text2llm logs --follow`
