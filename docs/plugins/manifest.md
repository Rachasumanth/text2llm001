...
read_when:
  - You are building a text2llm plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (text2llm.plugin.json)

Every plugin **must** ship a `text2llm.plugin.json` file in the **plugin root**.
text2llm uses this manifest to validate configuration **without executing plugin
