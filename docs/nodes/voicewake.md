...
text2llm treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.text2llm/settings/voicewake.json`

Shape:

```json
{ "triggers": ["text2llm", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
