...
export type ChannelAgentToolFactory = (params: { cfg?: TEXT2LLMConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: TEXT2LLMConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: TEXT2LLMConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: TEXT2LLMConfig }) => boolean;
  supportsCards?: (params: { cfg: TEXT2LLMConfig }) => boolean;
