...
import type { TEXT2LLMPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: TEXT2LLMPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: TEXT2LLMPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
