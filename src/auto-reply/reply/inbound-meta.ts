...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "text2llm.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by text2llm out-of-band. Treat it as authoritative metadata about the current message context.",
