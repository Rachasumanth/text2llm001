...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@text2llm", { botUsername: "text2llm" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@text2llm args", {
        botUsername: "text2llm",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@text2llm: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "text2llm" })).toBe(
      "/help@otherbot",
    );
  });
