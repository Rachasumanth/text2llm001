...
export const PLUGIN_MANIFEST_FILENAME = "text2llm.plugin.json";
...
// package.json "text2llm" metadata (used for onboarding/catalog)
...
export type TEXT2LLMPackageManifest = {
  extensions?: string[];
...
): TEXT2LLMPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
