...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/text2llm/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/text2llm/extensions",
        global: "/Users/x/.text2llm/extensions",
        workspace: "/Users/x/ws/.text2llm/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.text2llm/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/text2llm/extensions",
        global: "/Users/x/.text2llm/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.text2llm/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/text2llm/extensions",
        global: "/Users/x/.text2llm/extensions",
