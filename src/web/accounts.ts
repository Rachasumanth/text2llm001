...
export function listWhatsAppAuthDirs(cfg: TEXT2LLMConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: TEXT2LLMConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: TEXT2LLMConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: TEXT2LLMConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: TEXT2LLMConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: TEXT2LLMConfig): ResolvedWhatsAppAccount[] {
