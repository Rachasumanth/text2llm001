...
export function resolveTtsConfig(cfg: TEXT2LLMConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.TEXT2LLM_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: TEXT2LLMConfig): string | undefined {
