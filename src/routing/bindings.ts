...
export function listBindings(cfg: TEXT2LLMConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: TEXT2LLMConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: TEXT2LLMConfig) {
