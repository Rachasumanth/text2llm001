...
${formatHelpExamples([
  ['text2llm message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'text2llm message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'text2llm message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.text2llm.ai/cli/message")}`,
    )
    .action(() => {
