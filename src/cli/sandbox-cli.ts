...
const SANDBOX_EXAMPLES = {
  main: [
    ["text2llm sandbox list", "List all sandbox containers."],
    ["text2llm sandbox list --browser", "List only browser containers."],
    ["text2llm sandbox recreate --all", "Recreate all containers."],
    ["text2llm sandbox recreate --session main", "Recreate a specific session."],
    ["text2llm sandbox recreate --agent mybot", "Recreate agent containers."],
    ["text2llm sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["text2llm sandbox list", "List all sandbox containers."],
    ["text2llm sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["text2llm sandbox recreate --all", "Recreate all containers."],
    ["text2llm sandbox recreate --session main", "Recreate a specific session."],
    ["text2llm sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["text2llm sandbox recreate --browser --all", "Recreate only browser containers."],
    ["text2llm sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["text2llm sandbox explain", "Show effective sandbox config."],
    ["text2llm sandbox explain --session agent:main:main", "Explain a specific session."],
    ["text2llm sandbox explain --agent work", "Explain an agent sandbox."],
    ["text2llm sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.text2llm.ai/cli/sandbox")}\n`,
    )
    .action(() => {
