...
export const DEFAULT_SANDBOX_IMAGE = "text2llm-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "text2llm-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "text2llm-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "text2llm-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "text2llm-sbx-browser-";
