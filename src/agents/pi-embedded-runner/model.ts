...
// pi-ai's built-in Anthropic catalog can lag behind text2llm's defaults/docs.
...
export function buildModelAliasLines(cfg?: TEXT2LLMConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveTEXT2LLMAgentDir();
