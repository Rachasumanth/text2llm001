...
function resolveAvatarSource(cfg: TEXT2LLMConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: TEXT2LLMConfig, agentId: string): AgentAvatarResolution {
