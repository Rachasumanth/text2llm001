...
beforeAll(async () => {
  ...
  tempRoot = await fs.mkdtemp(path.join(os.tmpdir(), "text2llm-embedded-agent-"));
...
const ensureModels = (cfg: TEXT2LLMConfig) => ensureTEXT2LLMModelsJson(cfg, agentDir) as unknown;
