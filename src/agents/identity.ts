import type { TEXT2LLMConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: TEXT2LLMConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: TEXT2LLMConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[text2llm]";
}
