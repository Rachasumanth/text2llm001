...
function resolveWatchPaths(workspaceDir: string, config?: TEXT2LLMConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: TEXT2LLMConfig }) {
