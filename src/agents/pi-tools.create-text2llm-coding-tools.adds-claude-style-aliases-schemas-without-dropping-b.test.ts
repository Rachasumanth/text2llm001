...
describe("createTEXT2LLMCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createTEXT2LLMCodingTools({
      config,
    ...
    const anthropicTools = createTEXT2LLMCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createTEXT2LLMCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createTEXT2LLMCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
