...
export function listSlackAccountIds(cfg: TEXT2LLMConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: TEXT2LLMConfig): string {
...
function mergeSlackAccountConfig(cfg: TEXT2LLMConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: TEXT2LLMConfig): ResolvedSlackAccount[] {
