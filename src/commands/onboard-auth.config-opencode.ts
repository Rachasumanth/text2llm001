...
export function applyOpencodeZenProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyOpencodeZenConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
