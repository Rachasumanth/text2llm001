...
export function applyOpenrouterProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyOpenrouterConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyLitellmProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyMoonshotProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyMoonshotConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyMoonshotConfigCn(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyKimiCodeProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applySyntheticProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyXiaomiProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyXaiProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
...
export function applyQianfanProviderConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: TEXT2LLMConfig): TEXT2LLMConfig {
