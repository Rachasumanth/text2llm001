...
const ensureTEXT2LLMModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveTEXT2LLMAgentDir = vi.fn().mockReturnValue("/tmp/text2llm-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/text2llm-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureTEXT2LLMModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveTEXT2LLMAgentDir,
}));
