...
function resolveConfiguredModelRaw(cfg: TEXT2LLMConfig): string {
...
function resolveConfiguredModelKeys(cfg: TEXT2LLMConfig): string[] {
...
export function applyPrimaryModel(cfg: TEXT2LLMConfig, model: string): TEXT2LLMConfig {
...
export function applyModelAllowlist(cfg: TEXT2LLMConfig, models: string[]): TEXT2LLMConfig {
  const defaults = cfg.agents?.defaults;
