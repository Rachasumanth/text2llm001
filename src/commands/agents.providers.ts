...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: TEXT2LLMConfig): boolean {
...
export function summarizeBindings(cfg: TEXT2LLMConfig, bindings: AgentBinding[]): string[] {
