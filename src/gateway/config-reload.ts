...
import type { TEXT2LLMConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: TEXT2LLMConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: TEXT2LLMConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: TEXT2LLMConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: TEXT2LLMConfig) => void;
  log: {
