 ...
 *
 * Implements the OpenResponses `/v1/responses` endpoint for text2llm Gateway.
 *
  ...
  unsubscribe = onAgentEvent((evt) => {
    ...
    if (evt.stream === "lifecycle") {
      ...
      if (phase === "end" || phase === "error") {
        const finalText = accumulatedText || "No response from text2llm.";
