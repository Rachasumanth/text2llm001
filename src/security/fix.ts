...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof TEXT2LLMConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: TEXT2LLMConfig; env: NodeJS.ProcessEnv }): {
  cfg: TEXT2LLMConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
