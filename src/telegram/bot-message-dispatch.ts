...
import type { TEXT2LLMConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: TEXT2LLMConfig, agentId: string) {
  try {
