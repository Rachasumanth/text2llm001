...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.TEXT2LLM_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: TEXT2LLMConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: TEXT2LLMConfig): string {
...
function mergeTelegramAccountConfig(cfg: TEXT2LLMConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: TEXT2LLMConfig): ResolvedTelegramAccount[] {
