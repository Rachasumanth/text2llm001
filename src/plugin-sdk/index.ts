...
export type { TEXT2LLMConfig } from "../config/config.js";
/** @deprecated Use TEXT2LLMConfig instead */
export type { TEXT2LLMConfig as ClawdbotConfig } from "../config/config.js";
