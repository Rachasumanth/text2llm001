...
function isTelegramConfigured(cfg: TEXT2LLMConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: TEXT2LLMConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: TEXT2LLMConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: TEXT2LLMConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: TEXT2LLMConfig): boolean {
...
function isIMessageConfigured(cfg: TEXT2LLMConfig): boolean {
...
function isWhatsAppConfigured(cfg: TEXT2LLMConfig): boolean {
...
function isGenericChannelConfigured(cfg: TEXT2LLMConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: TEXT2LLMConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: TEXT2LLMConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: TEXT2LLMConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: TEXT2LLMConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: TEXT2LLMConfig, pluginId: string): TEXT2LLMConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
