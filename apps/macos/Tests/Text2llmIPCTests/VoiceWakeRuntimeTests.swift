...
@Suite struct VoiceWakeRuntimeTests {
    ...
    @Test func hasContentAfterTriggerFalseWhenOnlyTrigger() {
        let triggers = ["text2llm"]
        let text = "hey text2llm"
    ...
    @Test func gateRequiresGapBetweenTriggerAndCommand() {
        let transcript = "hey text2llm do thing"
        ...
        let config = WakeWordGateConfig(triggers: ["text2llm"], minPostTriggerGap: 0.3)
