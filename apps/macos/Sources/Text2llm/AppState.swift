...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = Text2llmConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = Text2llmConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = Text2llmConfigFile.loadDict()
            ...
            Text2llmConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/text2llm"
        state.remoteCliPath = ""
        return state
    }
}
