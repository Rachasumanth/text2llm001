...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.text2llm", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        Text2llmPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        Text2llmPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
