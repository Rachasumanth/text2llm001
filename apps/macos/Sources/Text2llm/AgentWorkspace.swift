...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.text2llm", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return Text2llmConfigFile.defaultWorkspaceURL() }
