...
private let onboardingWizardLogger = Logger(subsystem: "ai.text2llm", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between Text2llmProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = Text2llmProtocol.AnyCodable
