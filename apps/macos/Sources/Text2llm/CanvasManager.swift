...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.text2llm", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("text2llm/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__text2llm__/a2ui/").absoluteString + "?platform=macos"
    }
