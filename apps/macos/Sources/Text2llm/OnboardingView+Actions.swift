...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .text2llmSelectSettingsTab, object: tab)
        }
    }
    ...
    func finish() {
        UserDefaults.standard.set(true, forKey: "text2llm.onboardingSeen")
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            self.anthropicAuthStatus = "Connected. text2llm can now use Claude."
        } catch {
