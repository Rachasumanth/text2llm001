...
enum UIStrings {
    static let welcomeTitle = "Welcome to text2llm"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: Text2llmOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: Text2llmChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g text2llm@\(version)"
    }
