...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.text2llm.mac`) even if the shipped
    ...
    static func resolveNixMode(
        ...
        if environment["TEXT2LLM_NIX_MODE"] == "1" { return true }
        if standard.bool(forKey: "text2llm.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "text2llm.nixMode") { return true }
