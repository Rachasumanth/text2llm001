...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.text2llm", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other text2llm windows, but below the system’s pop-up menus.
