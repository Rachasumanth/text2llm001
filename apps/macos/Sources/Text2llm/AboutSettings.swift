...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/text2llm/text2llm") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/text2llm/text2llm")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://text2llm.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "Text2llmBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "Text2llmBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "Text2llmGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "Text2llmGitCommit") as? String) ??
            "unknown"
    }
