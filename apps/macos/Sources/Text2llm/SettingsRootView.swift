...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .text2llmSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? Text2llmPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? Text2llmPaths.stateDirURL.path
...
extension Notification.Name {
    static let text2llmSelectSettingsTab = Notification.Name("text2llmSelectSettingsTab")
}
