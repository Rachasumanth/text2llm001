...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.text2llm", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.text2llm", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [Text2llmChatMessage] = messages.compactMap { item in
