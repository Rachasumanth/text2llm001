...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.text2llm", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".text2llm/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.text2llmCommand(
            subcommand: "gateway",
