## text2llm Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_text2llm-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm text2llm gateway --port 18789 --verbose
```
