...
final class ScreenController {
    ...
    /// Callback invoked when an text2llm:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = Text2llmKitResources.bundle
...
/// Handles navigation policy to intercept text2llm:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept text2llm:// deep links.
        if url.scheme?.lowercased() == "text2llm" {
