...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = Text2llmLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = Text2llmLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.text2llm.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(Text2llmLocationMode.off.rawValue)
                            Text("While Using").tag(Text2llmLocationMode.whileUsing.rawValue)
                            Text("Always").tag(Text2llmLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while text2llm is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = Text2llmLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: Text2llmLocationMode {
        Text2llmLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
