...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: Text2llmPhotosLatestParams) async throws -> Text2llmPhotosLatestPayload {
        ...
        var results: [Text2llmPhotoPayload] = []
        ...
        return Text2llmPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> Text2llmPhotoPayload
    {
