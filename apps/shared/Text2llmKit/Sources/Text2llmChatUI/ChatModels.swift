...
public typealias Text2llmPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias Text2llmPlatformImage = UIImage
#endif

public struct Text2llmChatUsageCost: Codable, Hashable, Sendable {
...
public struct Text2llmChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: Text2llmChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(Text2llmChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct Text2llmChatMessageContent: Codable, Hashable, Sendable {
...
public struct Text2llmChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [Text2llmChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: Text2llmChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [Text2llmChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: Text2llmChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(Text2llmChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([Text2llmChatMessageContent].self, forKey: .content) {
...
public struct Text2llmChatHistoryPayload: Codable, Sendable {
...
public struct Text2llmSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct Text2llmSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [Text2llmSessionPreviewItem]
}

public struct Text2llmSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [Text2llmSessionPreviewEntry]

    public init(ts: Int, previews: [Text2llmSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct Text2llmChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct Text2llmChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct Text2llmAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct Text2llmChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct Text2llmGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct Text2llmPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: Text2llmPlatformImage?
...
public struct Text2llmChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
