...
@MainActor
struct Text2llmChatComposer: View {
    @Bindable var viewModel: Text2llmChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(Text2llmChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(Text2llmChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \Text2llmPendingAttachment.id)
                { (att: Text2llmPendingAttachment) in
                    HStack(spacing: 6) {
                        if let img = att.preview {
                            Text2llmPlatformImageFactory.image(img)
                                .resizable()
                                .scaledToFill()
    ...
    private var editor: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Rectangle()
                .fill(Text2llmChatTheme.divider)
                .frame(height: 1)
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(Text2llmChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(Text2llmChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(Text2llmChatTheme.subtleCard)
        .clipShape(Capsule())
    }
