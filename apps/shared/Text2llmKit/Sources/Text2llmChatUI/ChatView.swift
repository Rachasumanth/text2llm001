...
@MainActor
public struct Text2llmChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: Text2llmChatViewModel,
    ...
    private var visibleMessages: [Text2llmChatMessage] {
        let base: [Text2llmChatMessage]
    ...
    private func mergeToolResults(in messages: [Text2llmChatMessage]) -> [Text2llmChatMessage] {
        ...
        for message in messages {
            ...
            let merged = Text2llmChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: Text2llmChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: Text2llmChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: Text2llmChatMessage) -> String {
