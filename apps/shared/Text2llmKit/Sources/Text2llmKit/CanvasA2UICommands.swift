...
public enum Text2llmCanvasA2UICommand: String, Codable, Sendable {
...
public struct Text2llmCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct Text2llmCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
