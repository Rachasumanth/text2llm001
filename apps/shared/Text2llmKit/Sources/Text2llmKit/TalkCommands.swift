...
public enum Text2llmTalkCommand: String, Codable, Sendable {
...
public struct Text2llmTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct Text2llmTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
