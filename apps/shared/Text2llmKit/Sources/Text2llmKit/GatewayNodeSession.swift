...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.text2llm", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.text2llm", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: Text2llmProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
