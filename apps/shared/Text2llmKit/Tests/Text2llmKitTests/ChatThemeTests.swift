...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = Text2llmChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = Text2llmChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
