...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "text2llm", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for text2llm. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("text2llm Issue Label Audit");
