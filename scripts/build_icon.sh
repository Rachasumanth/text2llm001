...
# Defaults target the text2llm assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/text2llm/Resources/text2llm.icns"}
