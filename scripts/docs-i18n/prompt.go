...
- Keep product names in English: text2llm, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the text2llm Gateway, use “Gateway 网关”.
