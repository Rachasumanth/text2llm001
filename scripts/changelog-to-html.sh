...
if [[ -z "$version_content" ]]; then
  echo "<h2>text2llm $VERSION</h2>"
  echo "<p>Latest text2llm update.</p>"
  echo "<p><a href=\"https://github.com/text2llm/text2llm/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
