...
# Output:
# - dist/text2llm.app
# - dist/text2llm-<version>.zip
# - dist/text2llm-<version>.dmg
...
APP="$ROOT_DIR/dist/text2llm.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/text2llm-$VERSION.zip"
DMG="$ROOT_DIR/dist/text2llm-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/text2llm-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/text2llm-$VERSION.dSYM.zip"
