...
show_usage() {
    cat << EOF
clawlog - text2llm Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View text2llm logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    text2llm logs flow through the macOS unified log (subsystem: ai.text2llm).
