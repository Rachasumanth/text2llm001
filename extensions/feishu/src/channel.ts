import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "text2llm/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "text2llm/plugin-sdk";
