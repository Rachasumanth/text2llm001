...
export function listZalouserAccountIds(cfg: Text2llmConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: Text2llmConfig): string {
...
function mergeZalouserAccountConfig(cfg: Text2llmConfig, accountId: string): ZalouserAccountConfig {
