...
import { isWSL2Sync } from "text2llm/plugin-sdk";

const CLIENT_ID_KEYS = ["TEXT2LLM_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
const CLIENT_SECRET_KEYS = [
  "TEXT2LLM_GEMINI_OAUTH_CLIENT_SECRET",
...
async function discoverProject(accessToken: string): Promise<string> {
  ...
  const headers = {
    ...
    "X-Goog-Api-Client": "gl-node/text2llm",
  };
