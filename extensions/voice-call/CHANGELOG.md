...
- Version alignment with core text2llm release numbers.
...
- First public release of the @text2llm/voice-call plugin.
...
- CLI: `text2llm voicecall` commands (call/start/continue/speak/end/status/tail/expose).
