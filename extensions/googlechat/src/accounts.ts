...
export function listGoogleChatAccountIds(cfg: Text2llmConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: Text2llmConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: Text2llmConfig): ResolvedGoogleChatAccount[] {
