...
This directory contains the **BlueBubbles external channel plugin** for text2llm.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `text2llm/plugin-sdk` helpers.
