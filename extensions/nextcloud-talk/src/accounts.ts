...
import { DEFAULT_ACCOUNT_ID, isTruthyEnvValue, normalizeAccountId } from "text2llm/plugin-sdk";
import type { CoreConfig, NextcloudTalkAccountConfig } from "./types.js";

const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.TEXT2LLM_DEBUG_NEXTCLOUD_TALK_ACCOUNTS)) {
