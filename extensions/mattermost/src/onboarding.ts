import type { ChannelOnboardingAdapter, Text2llmConfig, WizardPrompter } from "text2llm/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.text2llm.ai/channels/mattermost",
    ].join("\n"),
